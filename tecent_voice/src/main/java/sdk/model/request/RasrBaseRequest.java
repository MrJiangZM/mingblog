...
import static sdk.config.AsrInternalConfig.REAL_ASR_URL;
import static sdk.config.AsrInternalConfig.SIGN_URL;
...
public class RasrBaseRequest {
     ...
     * </pre>
     */
    public void generateUrl(String voiceId) {
        this.signUrl = this.createSignUrl(voiceId);
        this.serverUrl = this.createServerUrl(voiceId);
     ...
     */
    protected String createServerUrl(String voiceId) {
     ...
     */
    protected String createSignUrl(String voiceId) {
        ...
        this.appendUriEntries(sb, voiceId);
        /*System.out.println("Generated sign URL: " + sb.toString());*/
        return sb.toString();
    }

    protected void appendUriEntries(StringBuilder sb, String voiceId) {
        TreeMap<String, Object> treeMap = this.initTreeMap(voiceId); // 用的时候才创建
     ...
     */
    protected TreeMap<String, Object> initTreeMap(String voiceId) {
