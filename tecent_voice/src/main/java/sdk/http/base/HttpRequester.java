...
import sdk.model.response.VoiceResponseParser;
import sdk.utils.SignBuilder;
...
public class HttpRequester {
     ...
     */
    public VoiceResponse sendAndParse(String voiceId, RasrBaseRequest rasrBasesRequest, byte[] dataPacket) {
        // 发请求，收取字符串回复。
        String responseStr = (String) this.send(voiceId, rasrBasesRequest, dataPacket);
        // 转成VoiceResponse对象：
     ...
     */
    public Object send(String voiceId, RasrBaseRequest rasrBasesRequest, byte[] dataPacket) {
        // 1. 创建Url：
        rasrBasesRequest.generateUrl(voiceId);
        // 2. 签名
        String sign = SignBuilder.createPostSign(rasrBasesRequest.getSignUrl(), rasrBasesRequest.getSecretKey());
        /*System.out.println("签名: " + sign);*/
        // 3. 请求
        return this.send(voiceId, rasrBasesRequest.getServerUrl(), sign, dataPacket);
    }
     ...
     * 发出请求到指定Url，返回收到的回复。
     */
    public Object send(String voiceId, String serverUrl, String sign, byte[] dataPacket) {
