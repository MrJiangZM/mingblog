...
public class CacheConfig {
    ...
    public Cache refreshAfterWriteCache(){
        return Caffeine.newBuilder()
                ...
                .build(key -> testService.getCacheService(String.valueOf(key)));
    }
...
//        int i = 10/0;
        log.info("This is myRemovalListener, removal key = {}, value = {}, cause = {}",key,value,cause);
    }
