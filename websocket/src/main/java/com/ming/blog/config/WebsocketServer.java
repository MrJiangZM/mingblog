...
import com.ming.blog.entity.Client;
...
public class WebsocketServer {
    ...
    /**
     * websocket封装的session,信息推送，就是通过session推送消息
     */
     ...
     * <p>
     * 这个标识用来处理websocket发送到服务器的数据
     */
    private final static String SYS_USERNAME = "mr_jiangzm";
...
//        return onlineCount;  // 如果维护onlineCount
